		...
		setLineArray(new Object[][] {
				...
				{"<html><code> &nbsp int x=0; </code></html>"},
					{new Choice[] {
						...
						new Choice("<html><code>for</code></html>",false),
						new Choice("<html><code>while</code></html>",true)},
					...
					{"<html><code> &nbsp </code></html>",
					 new Choice[]{
							new Choice("<html><code>x=x-1;</code></html>",false),
							new Choice("<html><code>x+=2;</code></html>",false),
							new Choice("<html><code>x=x+1;</code></html>",true)},
					},
					{"<html><code> &nbsp } <br> } </html></code>"}});
		
		setDescriptionPath("src/resources/Loops/Whileloops.htm");
		setPseudocodePath("src/resources/Loops/Pseudocode.txt");
		setGoodFeedbackPath("src/resources/Loops/GoodFeedback.html");
		setBadFeedbackPath("src/resources/Loops/BadFeedback.html");
	}
}
