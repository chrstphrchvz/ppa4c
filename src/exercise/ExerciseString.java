...
public class ExerciseString extends ExerciseTemplate {
	public ExerciseString() {
		setLineArray(new Object[][] {
				...
				{ "<html><code>&#13;</code></html>" },
				{
						...
						new Choice[] {
								...
								new Choice(
										...
										false),
								new Choice(
										"<html><code>strlen(string)</code></html>",
										true),
								new Choice(
										"<html><code>stln(string)</code></html>",
										false) }, "<html><code>;</code></html>" },
				...
				{ "<html><code>}</code></html>" }, });
		setDescriptionPath("resources/String/Strings.htm");
		setPseudocodePath("resources/String/Pseudocode.txt");
		setGoodFeedbackPath("resources/String/GoodFeedback.html");
		setBadFeedbackPath("resources/String/BadFeedback.html");
	}
}
