...
public class ExerciseArray extends ExerciseTemplate {
	public ExerciseArray() {
		setLineArray(new Object[][] {
				...
				{ "<html><code>&#13;</code></html>" },
				{
						...
						new Choice[] {
								...
								new Choice("<html><code>[1]=1</code></html>",
										false),
								new Choice("<html><code>=1</code></html>",
										false),
								new Choice("<html><code>(0)=1</code></html>",
										false), },
						"<html><code>;</code></html>", },

				{
						...
						new Choice[] {
								...
								new Choice("<html><code>[2]=2</code></html>",
										false),
								new Choice("<html><code>=2</code></html>",
										false),
								new Choice("<html><code>(1)=2</code></html>",
										false), },
						"<html><code>;</code></html>", },

				{
						...
						new Choice[] {
								...
								new Choice("<html><code>[3]=3</code></html>",
										false),
								new Choice("<html><code>=3</code></html>",
										false),
								new Choice("<html><code>(2)=3</code></html>",
										false), },
						"<html><code>;</code></html>", },
				...
				{ "<html><code>}</code></html>" }, });
		setDescriptionPath("resources/Arrays/Arrays.htm");
		setPseudocodePath("resources/Arrays/Pseudocode.txt");
		setGoodFeedbackPath("resources/Arrays/GoodFeedback.html");
		setBadFeedbackPath("resources/Arrays/BadFeedback.html");
	}
}
